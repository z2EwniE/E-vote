<?php
        ...
        if(isset($_POST['action'])) {
            ...
            try {
                ...
                $sql = "SELECT  positions.*,   partylists.*, CONCAT(students.first_name, ' ', students.middle_name, ' ', students.last_name) AS candidate_name  FROM votes 
                        ...
                        WHERE candidates.student_id = :id ORDER BY votes.voted_at";
                $stmt = $db->prepare($sql);
