...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-layout="default">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">College of Business Management and Entrepreneurship</h1><a
                            class="badge bg-primary ms-2" target="_blank">Yellow Eagles<i
                                    ...
                                    <div class="container mt-5">
                                        <table class="table table-responsive table-striped" id="studentTable"
                                            ...
                                            <?php
                                                ...
                                                INNER JOIN course ON students.course = course.course_id WHERE department.department_id = 3;";
                                                $stmt = $db->prepare($sql);
                                                $stmt->execute();
    ...
    function updateSortIcons(columnIndex, isAscending) {
        ...
        thElements.forEach((icon, idx) => {
            ...
            if (idx === columnIndex) {
                icon.className = isAscending ? 'fas fa-sort-up' :
                'fas fa-sort-down'; // Update the clicked column icon
            }
        });
    }
    </script>
